require_relative '../../source/views_counter/all'

describe ViewsCounter::All do
  describe '#call' do
    ...
    let(:expected_response) do
      [ "/help_page/1 4 visits", "/about/2 2 visits", "/contact 2 visits", "/home 2 visits", "/about 1 visits", "/index 1 visits"]
    end
